...
<div class="container">
		...
		<h3>신고된 게시물</h3><br/>
		<div class="card">
		  <div class="card-body" onclick="location.href='/post/detail/${post.report_post_num }'">
		  	
		  	게시글 번호 : ${post.report_post_num }<br/>
		  	작성자 아이디 : ${postvo.writer } <br/>
			제목 : <span>${postvo.title }</span><br/>
			내용 : ${postvo.content }
		  </div>
		</div>
		<hr/>
		...
		<div class="row w-100 m-0">
			...
			<a href="/report/reportPostDelete/${post.report_pnum }" class="btn btn-outline-danger w-100">신고내역 삭제</a>		
		</div>	
			<form action="/post/delete/${postvo.post_num }" method="post">
