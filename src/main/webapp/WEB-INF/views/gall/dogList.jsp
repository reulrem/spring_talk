	...
	<div class="container">
		...
		<table boarder="1" class="table table-hover">
		    ...
		    <div class="d-flex justify-content-end">
			    <a href="/gall/insert/${gall_name}" class="btn ">게시글 작성</a><hr/>
		    </div>
		    ...
		    <c:if test="${pageMaker.next }">
		  	...
		  	<!-- 검색창 부분 -->
		  	<form action="/gall/list/gall_dog" method="get" class="d-flex justify-content-center">
				...
				<div class="d-flex justify-content-end">
					<input type="submit" id="submitBtn" class="btn btn-outline-dark" value="검색">
				</div>
			<form>
